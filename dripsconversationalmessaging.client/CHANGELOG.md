...
- Create Angular project with ng: `ng new dripsconversationalmessaging.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`dripsconversationalmessaging.client.esproj`).
